    ...
    <div class="main-container d-flex">
        <div class="sidebar" id ="side_nav">
            ...
            <ul class="list-unstyled px-2">
                ...
                <li class="active"><a href="courses.php" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-table"></i>&nbsp;Courses</a></li>
        ...
        <div class="table-wrapper">
            ...
            $sql = "SELECT Course_ID, Course_Name,Credits,dept_name,PreReqID,CourseType FROM courses,department where department.dept_Id=courses.dept_id";
                ...
                if ($queryResult->num_rows > 0) {
                    while ($rowObj = $queryResult->fetch_object()) {
                        echo "<tr>
                            ...
                            <td><a style='color: black' id='delete' href=del.php?id={$rowObj->Course_ID}><i class='fas fa-trash'></i></a></td>";
                    }
                }
            }
            ?>
