...
<body>
    ...
    $query = "SELECT Course_ID, Course_Name,Credits,dept_name,PreReqID,CourseType FROM courses,department where department.dept_Id=courses.dept_id";
    ...
    <tr>
        ...
        <th>Credits</th>
        <th>Department</th>
        <th>Pre-Requisite ID Taken(Ongoing)</th>
        <th>Course Type</th>
    </tr>
    </thead>
    <?php
